...
var _default = "https://tourism-webapp.herokuapp.com/";
...
var login = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(email, pass) {
    var res;
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "post",
              url: "".concat(_utils.default, "api/v1/users/login"),
              data: {
                email: email,
                password: pass
              }
          ...
          case 3:
            res = _context.sent;
            (0, _alerts.showAlert)("success", "Succesfully Logged In");
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return _axios.default.get("".concat(_utils.default, "api/v1/users/logout"));
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "post",
              url: "".concat(_utils.default, "api/v1/users/signup"),
              data: data
            });

          case 3:
            res = _context3.sent;
            (0, _alerts.showAlert)("success", "Succesfully Signed Up");
            window.setTimeout(function () {
              location.assign("/");
            }, 1000);
            _context3.next = 11;
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js","./utils":"utils.js"}],"mapbox.js":[function(require,module,exports) {
"use strict";
...
var displaymap = function displaymap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>".concat(loc.description, "</p>")).addTo(map); //extend map bound to include current location
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "patch",
              url: "".concat(_utils.default, "api/v1/users/updateProfile"),
              data: data
            });

          case 3:
            res = _context.sent;
            if (res.data.status == "success") (0, _alerts.showAlert)("success", "Data updated succesfully");
            _context.next = 10;
            break;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "patch",
              url: "".concat(_utils.default, "api/v1/users/updatePassword"),
              data: {
          ...
          case 3:
            res = _context2.sent;
            if (res.data.status == "success") (0, _alerts.showAlert)("success", "Password updated succesfully");
            _context2.next = 10;
            break;
...
},{"./alerts":"alerts.js","axios":"../../node_modules/axios/index.js","./utils":"utils.js"}],"resetPassword.js":[function(require,module,exports) {
"use strict";
...
var resetuserPassword = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(token, password, confirmPassword) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "PATCH",
              url: "".concat(_utils.default, "api/v1/users/resetPassword/").concat(token),
              data: {
                password: password,
                confirmPassword: confirmPassword
              }
          ...
          case 3:
            res = _context.sent;
            (0, _alerts.showAlert)("success", "Password has changed successfully");
            _context.next = 10;
            break;
  ...
  return function resetuserPassword(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();

exports.resetuserPassword = resetuserPassword;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js","./utils":"utils.js"}],"booking.js":[function(require,module,exports) {
"use strict";
...
var bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(user, price, tour, tourist, age) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "post",
              url: "".concat(_utils.default, "api/v1/bookings"),
              data: {
                tour: tour,
                user: user,
                price: price,
          ...
          case 3:
            res = _context.sent;
            (0, _alerts.showAlert)("success", "Your booking has been confirmed. Kindly check it in 'My Bookings' Section");
            _context.next = 10;
            break;
  ...
  return function bookTour(_x, _x2, _x3, _x4, _x5) {
    return _ref.apply(this, arguments);
  };
}();

exports.bookTour = bookTour;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js","./utils":"utils.js"}],"review.js":[function(require,module,exports) {
"use strict";
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = "".concat(_utils.default, "api/v1/reviews").concat(data.review ? "/" + data.review : "");
            _context.next = 4;
            return (0, _axios.default)({
              method: "".concat(data.review ? "PATCH" : "POST"),
              url: url,
              data: {
                review: data.desc,
                rating: data.rating,
          ...
          case 4:
            res = _context.sent;
            (0, _alerts.showAlert)("success", "Thank you for reviewing the Tour");
            window.setTimeout(function () {
              location.assign("/");
            }, 2000);
            _context.next = 12;
...
},{"./alerts":"alerts.js","axios":"../../node_modules/axios/index.js","./utils":"utils.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var settings = _interopRequireWildcard(require("./updateSettings"));
...
var logOut = document.querySelector(".log___out");
...
if (userFormData) userFormData.addEventListener("submit", function (e) {
  e.preventDefault(); //To send an image to the server using form, we have to use FormData Class. This type of form is known as multi-part form, which is used to send files to the server.
...
if (userFormPassword) userFormPassword.addEventListener("submit", /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(e) {
    var currentPassword, password, confirmPassword, btn;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            btn = document.querySelector(".update-password");
            btn.textContent = "saving password...";
            _context2.next = 8;
            return settings.updatePassword(currentPassword, password, confirmPassword);
...
if (resetPassword) resetPassword.addEventListener("submit", function (e) {
  e.preventDefault();
  var token = resetPassword.dataset.token;
  var password = document.getElementById("password").value;
  var confirmPassword = document.getElementById("password-confirm").value;
  (0, _resetPassword.resetuserPassword)(token, password, confirmPassword);
});
if (bookTourForm) bookTourForm.addEventListener("submit", /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(e) {
    var user, price, tour, tourist, age;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            e.preventDefault();
            user = bookTourForm.dataset.user;
            price = bookTourForm.dataset.price;
            tour = bookTourForm.dataset.tour;
            tourist = document.getElementById("tourist").value;
            age = document.getElementById("age").value;
            document.querySelector(".pay-now").textContent = "Paying...";
            _context3.next = 9;
            return (0, _booking.bookTour)(user, price, tour, tourist, age);
...
if (reviewForm) reviewForm.addEventListener("submit", function (e) {
  e.preventDefault();
  var user = reviewForm.dataset.user;
  var tour = reviewForm.dataset.tour;
  var review = reviewForm.dataset.review;
  var desc = document.getElementById("desc").value;
  var rating = document.getElementById("rating").value;
  (0, _review.submitReview)({
    user: user,
    tour: tour,
    review: review,
    desc: desc,
